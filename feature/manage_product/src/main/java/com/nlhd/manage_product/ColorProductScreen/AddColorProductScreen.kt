...
fun AddColorProductScreen(
    ...
    val addColorState by viewModel.addColorProductState.collectAsStateWithLifecycle()
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = {
                    Text("Add color product", style = AppTheme.typography.headlineLarge.copy(
                ...
                Row(
                    ...
                    OutlinedButton(
                        onClick = {
                            ...
                            viewModel.addColorProduct(keyStore.value, versionProductId, context)
                        },
                        modifier = Modifier.weight(1f),
                        colors = ButtonDefaults.buttonColors(
        ...
        when (addColorState) {
            is AddColorProductState.Error -> {
                Toast.makeText(context, (addColorState as AddColorProductState.Error).message, Toast.LENGTH_SHORT).show()
                onClickBack()
            }
            AddColorProductState.Idle -> {}
            AddColorProductState.Loading -> {
            ...
            is AddColorProductState.Success -> {
